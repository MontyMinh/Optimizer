...
class Data:
    ...
    factory_sizes:dict = dict()
    customer_sizes:dict = dict()
        
    factory_names:dict = dict()
    
    dimF:int = 0
    dimC:int = 0 
    dimFC:int = 0
        
    inbound_cost_per_product:np.ndarray = np.array([])
    outbound_cost_per_product:np.ndarray = np.array([])
        
    objective_vector:np.ndarray = np.array([])
        
    demand_matrix:np.ndarray = np.array([])
        
    efficiency_per_product:dict = dict()
    inbound_combination_matrices:dict = dict()
    outbound_combination_matrices:= dict()
    
    capacity_constraints:= []
    capacity_matrix:np.ndarray = np.array([])
    capacity_rows:int = 0
    
    supply_constraints:list = []
    supply_matrix:np.ndarray = np.array([])
    supply_rows:int = 0

    demand_volume:np.ndarray = np.array([])
    capacity_volume:np.ndarray = np.array([])
    constraints_vector:np.ndarray = np.array([])
